				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<form role="form" action="CandidateRegistration" method="post"
							...
							<button type="submit" class="btn btn-info" id="btnValidate">Send Nomination Request To Admin</button>
							
							<%-- <button type="submit" class="btn btn-info" id="btnValidate">Create Account</button>
							<a class="for-pwd" href="candidate-login.jsp">Already Registered</a> --%>
						</form>
					</div>
				</div>
			</div>
