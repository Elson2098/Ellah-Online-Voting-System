...
<body class="host_version">
	...
	<div class="container">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">Candidate Login</h4>
			</div>
		</div>
		<div class="row">
				...
				<div class="panel panel-default">
					...
					%>
						<form action="CandidateLogin" method="post">
							...
							<a class="for-pwd" href="candidate-registration.jsp">New Candidate Register</a>
							<a class="for-pwd" href="candidate-forgot-password.jsp">Forgot Password</a>
						</form>
					</div>
				</div>
			</div>
