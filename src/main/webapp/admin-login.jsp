...
<body class="host_version">
	...
	<div class="container">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line"><b><u><i>ADMIN ELSON'S LOGIN PANEL</i></u></b></h4>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-danger">
					<div class="panel-heading"><b><u>ADMIN LOGIN</u></b></div>
					<div class="panel-body">
						...
						<form action="AdminLogin" method="post">
							...
							<div class="form-group">
								<label>Password</label> <input class="form-control" type="password" name="upass" required/>
							</div>
							<%
								String captcha = null;
							...
							<a class="for-pwd" href="admin-forgot-password.jsp">Forgot your password?</a>
						</form>
					</div>
				</div>
			</div>
