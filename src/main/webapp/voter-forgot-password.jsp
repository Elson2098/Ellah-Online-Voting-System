...
<body class="host_version">
	...
	<div class="container">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line"><b><u>VOTER FORGOT PASSWORD PANEL</u></u></b></h4>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div class="panel panel-danger">
					<div class="panel-heading"><b><u>FORGOT PASSWORD SECTION</u></u></b></div>
					<div class="panel-body">
						<form action="voter-reset-password.jsp" method="post">
							<div class="form-group">
								<label>Enter your email address</label> <input class="form-control"
